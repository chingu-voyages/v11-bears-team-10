...
function TodoView({ showForm, setOpen }) {
	const [todoData] = useState({
		...
		todos: new Set(["setup app folder", "install dependencies", "notify team members"])
	});
	...
	return showForm ? (
		<>
			<div className="d-flex flex-col todos-portal">
				...
				<form className="d-flex flex-col portal-form">
				...
				<div className="d-flex flex-col checkboxes">
